<?php
/*
Single Post Template: Landwash Issue
*/
?>
...
<h1 style="margin: 0px 0px 15px 0px; color: orange; font-family: arial; font-size: 20px; text-shadow: -1px 1px #404040;"><?php the_title(); ?></h1>
